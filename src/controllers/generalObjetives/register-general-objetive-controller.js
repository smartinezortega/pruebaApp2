...
// @desc    Create general objetive
// @route   POST /api/objetivosgenerales
// @access  Private/Admin
const registerGeneralObjetive = asyncHandler(async (req, res) => {
  const {
    task,
    dificulty,
    unit_min,
...
module.exports = registerGeneralObjetive
