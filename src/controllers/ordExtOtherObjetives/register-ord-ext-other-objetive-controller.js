...
// @desc    Create ord/ext/other objetive
// @route   POST /api/objetivosordextotros
// @access  Private/Admin
const registerOrdExtOtherObjetive = asyncHandler(async (req, res) => {
  const {
    task,
    dificulty,
    unit_min,
...
module.exports = registerOrdExtOtherObjetive
